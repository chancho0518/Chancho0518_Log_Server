...
class PostControllerTest {
    ...
    @Test
    @DisplayName("글 단건 조회")
    void getOnePostControllerTest() throws Exception {
    ...
    void servicePolicyTest() throws Exception {
    ...
    void getListControllerTest() throws Exception {
    ...
    @Test
    @DisplayName("글 리스트 0page 조회시 페이징 예외 처리")
    void getListControllerExceptionTest() throws Exception {
    ...
    void titleEditContollerTest() throws Exception {
    ...
    @Test
    @DisplayName("글 삭제")
    void deleteContollerTest() throws Exception {
